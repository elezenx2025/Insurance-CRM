...
export default function ClaimsBulkUploadPage() {
  const router = useRouter()
  const [showUploadModal, setShowUploadModal] = useState(false)
  const [uploadHistory, setUploadHistory] = useState([
    {
      id: '1',
      fileName: 'claims_batch_1.xlsx',
      uploadedAt: '2024-01-15T10:30:00Z',
      status: 'completed',
      recordsProcessed: 75,
      recordsSuccessful: 73,
      recordsFailed: 2,
      errors: ['Row 23: Invalid claim number format', 'Row 45: Missing required field']
    },
    {
      id: '2',
      fileName: 'claims_batch_2.xlsx',
  ...
  const downloadTemplate = () => {
    try {
      ...
      link.href = '/templates/claim-bulk-upload-template.csv'
      link.download = 'claim-bulk-upload-template.csv'
      link.target = '_blank'
    ...
    <div className="space-y-6">
          ...
          <ol className="flex items-center space-x-4">
            ...
            <li>
              <div className="flex items-center">
                ...
                <button onClick={() => router.push('/dashboard/claims')} className="ml-4 text-gray-400 hover:text-gray-500">
                  Claims
                </button>
              </div>
            </li>
      ...
      <div className="flex justify-between items-center">
        <div className="flex items-center space-x-4">
          ...
          <div>
            <h1 className="text-lg font-semibold text-gray-900">Claims Bulk Upload</h1>
            <p className="mt-1 text-sm text-gray-600">
              Upload multiple claims at once using Excel files
            </p>
          </div>
        </div>
        <button
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-lg p-6">
        ...
        <div className="space-y-3 text-sm text-blue-800">
          ...
          <div className="flex items-start">
            ...
            <span>Fill in the claim data following the template structure</span>
          </div>
          <div className="flex items-start">
      ...
      <BulkUploadModal
        ...
        title="Upload Claims"
        description="Upload an Excel file containing claim data. The file should follow the template format."
        acceptedFileTypes={['.csv', '.xlsx', '.xls']}
        maxFileSize={10}
        onUpload={handleUpload}
        templateUrl="/templates/claim-bulk-upload-template.csv"
      />
    </div>
  )
}
