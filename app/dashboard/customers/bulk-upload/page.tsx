...
export default function CustomersBulkUploadPage() {
  ...
  const [uploadHistory, setUploadHistory] = useState([
    {
      id: '1',
      fileName: 'customers_batch_1.xlsx',
      uploadedAt: '2024-01-15T10:30:00Z',
      status: 'completed',
      recordsProcessed: 200,
      recordsSuccessful: 195,
      recordsFailed: 5,
      errors: ['Row 12: Invalid email format', 'Row 45: Missing required field', 'Row 78: Duplicate customer']
    },
    {
      id: '2',
      fileName: 'customers_batch_2.xlsx',
  ...
  const downloadTemplate = () => {
    try {
      ...
      link.href = '/templates/customer-bulk-upload-template.csv'
      link.download = 'customer-bulk-upload-template.csv'
      link.target = '_blank'
    ...
    <div className="space-y-6">
          ...
          <ol className="flex items-center space-x-4">
            ...
            <li>
              <div className="flex items-center">
                ...
                <button onClick={() => router.push('/dashboard/customers')} className="ml-4 text-gray-400 hover:text-gray-500">
                  Customers
                </button>
              </div>
            </li>
      ...
      <div className="flex justify-between items-center">
        <div className="flex items-center space-x-4">
          ...
          <div>
            <h1 className="text-lg font-semibold text-gray-900">Customers Bulk Upload</h1>
            <p className="mt-1 text-sm text-gray-600">
              Upload multiple customers at once using Excel files
            </p>
          </div>
        </div>
        <button
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-lg p-6">
        ...
        <div className="space-y-3 text-sm text-blue-800">
          ...
          <div className="flex items-start">
            ...
            <span>Fill in the customer data following the template structure</span>
          </div>
          <div className="flex items-start">
      ...
      <BulkUploadModal
        ...
        description="Upload an Excel file containing customer data. The file should follow the template format."
        acceptedFileTypes={['.csv', '.xlsx', '.xls']}
        maxFileSize={10}
        onUpload={handleUpload}
        templateUrl="/templates/customer-bulk-upload-template.csv"
      />
    </div>
  )
}
